...
dev.copy(png, file="C:/Users/armys/OneDrive/Documents/Coursera Class/Data Science Specialization/Exploring Data/Week 1/plot4.png", height=480, width=480)
